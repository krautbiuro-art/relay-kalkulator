...
st.caption("Aplikacja do szybkiego rozliczania tras na podstawie danych z bloku Amazon i kart UTA.")
...
manual_km = st.sidebar.number_input("🗺️ Przebieg km (z bloku / GPS)", value=4415.8, step=10.0)
manual_liters = st.sidebar.number_input("⛽ Zużyte paliwo (Litry z UTA / CAN)", value=0.0, step=10.0)
...
if calculate_btn:
    ...
    st.info("👈 Wpisz kilometry oraz stawkę i kliknij **'Przelicz koszty i zysk'**.")
